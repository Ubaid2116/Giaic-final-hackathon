        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                {cartItems.map((item) => (
                  <tr key={item.id} className="border-b border-gray-200 hover:bg-gray-100">
                    <td className="py-4 px-4 flex items-center space-x-3">
                      ...
                      />
                      <span className="text-sm font-medium text-[#252B42]">{item.name}</span>
                    </td>
          ...
          <div className="mt-8 flex justify-end">
            <div className="bg-white shadow-lg rounded-lg p-6 w-full sm:w-1/3">
              <h2 className="text-xl font-bold text-[#252B42] mb-4">Order Summary</h2>
              <div className="flex justify-between mb-3">
                <span className="text-sm font-semibold text-gray-600">Subtotal</span>
                <span className="text-sm font-semibold text-gray-600">${totalPrice.toFixed(2)}</span>
              </div>
              <div className="flex justify-between mb-6">
                <span className="text-lg font-bold text-[#252B42]">Total</span>
                <span className="text-lg font-bold text-[#252B42]">${totalPrice.toFixed(2)}</span>
              </div>
              <button
